<form class="create-edit" method="POST" action="{{ route('menu.item.store') }}" enctype="multipart/form-data">
    ...
    <div id="price-field" style="display: none;">
        ...
        <input type="number" name="price" id="price" placeholder=" " min="0">
    ...
    <div class="size-fields" style="display: none;">
        ...
        <input type="number" name="price_s" id="price-s" placeholder=" " min="0">
    </div>
    <div class="size-fields" style="display: none;">
        <label for="price-m">Цена M</label>
        <input type="number" name="price_m" id="price-m" placeholder=" " min="0">
    </div>
    <div class="size-fields" style="display: none;">
        <label for="price-l">Цена L</label>
        <input type="number" name="price_l" id="price-l" placeholder=" " min="0">
    </div>
